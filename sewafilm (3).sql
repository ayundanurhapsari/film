...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2020 at 12:38 PM
...
(8, 2020, 'Mariposa', 'Romance', 'Angga Yunanda, Zara', '32000', 'Kisah asmara dua remaja'),
(9, 2018, 'Sajen', 'Horror', 'Amanda Manopo, Angga Y', '30000', 'Misteri sajen di SMA Pelita Bangsa'),
...
(1, 1, 'Ayunda', 212121, '2020-07-27', '2020-07-28', '50000'),
(2, 2, 'Nur', 65657, '2020-07-15', '2020-07-16', '84000'),
(3, 2, 'Hapsari', 4356789, '2020-07-19', '2020-07-21', '90000'),
(12, 3, 'Ciko', 677564538, '2020-08-02', '2020-08-03', '60000');
...
--
ALTER TABLE `sewa`
  MODIFY `id_sewa` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
